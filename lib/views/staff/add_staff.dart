      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _buildTextFieldWithHeading(_nameKey, "name".tr, context,
                namecontroller, "name".tr, TextInputType.name),
            const SizedBox(height: 5),
            _buildTextFieldWithHeading(_emailKey, "email".tr, context,
                emailcontroller, "email".tr, TextInputType.emailAddress),
            const SizedBox(height: 5),
            _buildTextFieldWithHeading(_passwordKey, "password".tr, context,
                passwordcontroller, "password".tr, TextInputType.visiblePassword),
            const SizedBox(height: 5),
            _buildTextFieldWithHeading(_phoneKey, "phone".tr, context,
                phonecontroller, "phone".tr, TextInputType.number),
            const SizedBox(height: 5),
            Padding(
