class OutForDeilveryModel {
  bool? success;
  List<OutForDeilveryModelData>? data;

  OutForDeilveryModel({this.success, this.data});

  OutForDeilveryModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['data'] != null) {
      data = <OutForDeilveryModelData>[];
      json['data'].forEach((v) {
        data!.add(new OutForDeilveryModelData.fromJson(v));
      });
    }
  }
...
class OutForDeilveryModelData {
  ...
  OutForDeilveryModelData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
