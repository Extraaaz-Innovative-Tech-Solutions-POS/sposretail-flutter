class AdvancePendingOrder {
  bool? success;
  List<AdvancePendingOrderData>? data;
  String? message;

  AdvancePendingOrder({this.success, this.data, this.message});

  AdvancePendingOrder.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['data'] != null) {
      data = <AdvancePendingOrderData>[];
      json['data'].forEach((v) {
        data!.add(new AdvancePendingOrderData.fromJson(v));
      });
    }
...
class AdvancePendingOrderData {
  ...
  var totalTax;
  var grandTotal;
  var totalGivenAmount;
  var remainingMoney;
  List<Items>? items;
  List<Payments>? payments;

  AdvancePendingOrderData(
      {this.id,
      this.tableId,
      this.orderNumber,
      this.isready,
  ...
  AdvancePendingOrderData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
